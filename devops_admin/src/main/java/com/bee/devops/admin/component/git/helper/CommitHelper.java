...
/**
 * A wrapper class for commits to make them easier to interact with and
 * preserves certain aspects that are expensive to look up with JGit's standard
 * RevCommit, e.g. parents, children, and author.
 */
public class CommitHelper {
	...
	/**
	 * Constructs a helper for the given commit. Note that if c is not a fully
	 * parsed commit this constructor will fail and throw errors. Using one of
	 * the other constructors will parse the info.
	 *
	 * @param c
	 *            a fully parsed commit
	 */
	...
	/**
	 * Constructs a helper after parsing the commit corresponding to the given
	 * ObjectId
	 * 
	 * @param id
	 *            the id of the commit to parse and wrap
	 * @param repoHelper
	 *            the repoHelper with the repository necessary to parse the
	 *            commit
	 * @throws IOException
	 */
	...
	/**
	 * Constructs a helper from a reference string by getting its corresponding
	 * id and then parsing the corresponding commit
	 * 
	 * @param refString
	 *            the string corresponding to some commit
	 * @param repoHelper
	 *            the repoHelper with the repository necessary to parse the
	...
	/**
	 * @param fullMessage
	 *            whether to return the full or abbreviated commit message
	...
	/**
	 * @return the formatted date string corresponding to the time of this
	 *         commit
	 */
	...
	/**
	 * Checks to see if the given commit has this commit as an ancestor, up to
	 ...
	 *            the commit to check
	 * @param depth
	 *            how many generations down to check
	...
	/**
	 * @param t
	 *            a TagHelper for a tag that references this commit
	 */
	...
	/**
	 * @param s
	 *            a TagHelper that will be deleted
	 */
	...
	private class ParentCommitHelper {
		 ...
		 * 
		 * @param child
		 *            the child associated with this object
		 */
