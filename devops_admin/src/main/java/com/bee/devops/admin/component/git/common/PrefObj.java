package com.bee.devops.admin.component.git.common;
...
/**
 * A class that sneakily stores any object with the Java Preferences API.
 *
...
public class PrefObj {
	...
	static private void writePieces(Preferences prefs, String key, byte pieces[][]) throws BackingStoreException {
