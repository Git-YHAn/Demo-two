...
public class StopInstancesJsonUnmarshaller implements Unmarshaller<StopInstancesResponse, JsonUnmarshallerContext> {

	@Override
	public StopInstancesResponse unmarshall(JsonUnmarshallerContext context) throws Exception {
		StopInstancesResponse result = new StopInstancesResponse();
