...
public class UserConfigRecordsResponse {
	...
	public UserConfigRecordsResponse() {
		super();
	}

	public static List<UserConfigRecordsResponse> transList(List<OpsConfig> list) {
		List<UserConfigRecordsResponse> result = new ArrayList<>();
		for (OpsConfig record : list) {
			result.add(new UserConfigRecordsResponse(record));
		}
		return result;
	}

	public UserConfigRecordsResponse(OpsConfig record) {
		super();
