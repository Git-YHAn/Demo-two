...
public class RebootInstancesJsonUnmarshaller implements Unmarshaller<RebootInstancesResponse, JsonUnmarshallerContext> {

	@Override
	public RebootInstancesResponse unmarshall(JsonUnmarshallerContext context) throws Exception {
		RebootInstancesResponse result = new RebootInstancesResponse();
